        ...
        <div class="row">
            <div class="col-md-12 txtc text-center ccase">
                <div class="brpt brptsize">
                    <h1 class="brcrumb_title">Order Confirmation</h1>
                </div>
                <div class="breadcumb-inner">
                    <ul>
                        <li>You Are Here: </li>
                        <li>-<a href="{{ route('home') }}"> Home</a></li>
                        <li>-<span class="current"> Order Confirmation</span></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="confirmation_box">
                    ...
                    <div class="action_buttons text-center mt-4">
                        <a href="{{ route('shop') }}" class="continue_shopping_btn">Continue Shopping</a>
                        @if (Auth::check())
                            <a href="{{ route('my.orders') }}" class="my_orders_btn">My Orders</a>
                        @endif
                    </div>
                </div>
            </div>
